...
pt1 = input('Введите название точки: ')
pt2 = 'Останкинская башня'
...
i = lonlat_distance(toponym_coodrinates1, toponym_coodrinates2)
h2 = ((i - 3.6 * math.sqrt(525)) / 3.6) ** 2
print(f'Высота антенны в данной точке должна быть: {h2:.3f} метров')